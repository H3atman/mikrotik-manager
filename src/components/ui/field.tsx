...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-[checked=true]:bg-primary/5 has-data-[checked=true]:border-primary/30 dark:has-data-[checked=true]:border-primary/20 dark:has-data-[checked=true]:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border *:data-[slot=field]:p-2 group/field-label peer/field-label flex w-fit leading-snug",
